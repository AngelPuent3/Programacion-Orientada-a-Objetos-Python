import tienda
from tienda import *
class Refrigerador(Tienda,Electro):
    def __init__(self):
        super().__init__()
    ...
    #     refrilist=[]
    #     r=Refrigerador()
    #     print("Ingrese la informacion del refrigederador")
    #     r.codigo=int(input("Ingrese el codigo del refrigerador: "))
    #     r.nombre=str(input("Ingrese el nombre del refrigerador: "))
    #     r.tamaño=float(input("Ingrese el tamaño del refrigerador: "))
    #     r.precio=float(input("Ingrese el precio del refrigerador: "))
